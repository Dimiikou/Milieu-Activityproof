...
if (isset($_POST['aktivitaetstyp']) && isset($_POST['screenshot'])) {
        date_default_timezone_set("Europe/Amsterdam");
        $date = date('d/m/Y', time());

        $activityProofMySQL->insertRoleplayActivity($_SESSION['uuid'], $_POST['aktivitaetstyp'], $date, $_POST['screenshot']);
        header('Location: ./addRoleplayActivity?success=true');
}
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="center col s6">
                                RP-Typ <br />
                                <p style="font-size: 55%;">blacklist, ausraub, menschenhandel, transport, autoverkauf, drogenhandel, verhandlung, sonstiges</p>
                            </div>
                            <div class="center col s6">
                                Screenshot
                            </div>
